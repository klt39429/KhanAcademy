	...
	myNameSpace.DownloadWindow = function() {
		...
		var _init = function() {
			...
			onefileButton.addEventListener('click', function() {
				...
				utility.downloadOneFile("http://s3.amazonaws.com/KA-youtube-converted/wYrxKGt_bLg.mp4/wYrxKGt_bLg.mp4", Titanium.Filesystem.applicationDataDirectory + '1.mp4', _callBack_DownloadOneFileFinished);
