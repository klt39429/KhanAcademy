...
// in simulator we redefine to format for KhanAcademy Developer console
...
{\
	NSString * exceptionName = [@"org.khanacademy." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.khanacademy";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIKhanAcademyNativeItemNone = -1, 
	UIKhanAcademyNativeItemSpinner = -2,
	UIKhanAcademyNativeItemProgressBar = -3,
	
	UIKhanAcademyNativeItemSlider = -4,
	UIKhanAcademyNativeItemSwitch = -5,
	UIKhanAcademyNativeItemMultiButton = -6,
	UIKhanAcademyNativeItemSegmented = -7,
	
	UIKhanAcademyNativeItemTextView = -8,
	UIKhanAcademyNativeItemTextField = -9,
	UIKhanAcademyNativeItemSearchBar = -10,
	
	UIKhanAcademyNativeItemPicker = -11,
	UIKhanAcademyNativeItemDatePicker = -12,
	
	UIKhanAcademyNativeItemInfoLight = -13,
	UIKhanAcademyNativeItemInfoDark = -14,
	
	UIKhanAcademyNativeItemDisclosure = -15,
	
	UIKhanAcademyNativeItemContactAdd = -16
};
