 ...
 * Copyright (c) 2009-2011 by KhanAcademy, Inc. All Rights Reserved.
...
//@interface KhanAcademyObject : NSObject
//@end

@interface KhanAcademyObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[KhanAcademyObject class]])
		{
			for (NSString *key in [[(KhanAcademyObject*)o modules] allKeys])
			{
