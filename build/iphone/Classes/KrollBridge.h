...
@interface KhanAcademyObject : KrollCoverageObject {
#else
@interface KhanAcademyObject : KrollObject {
#endif
@private
...
extern NSString * KhanAcademy$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	KhanAcademyObject *_khanacademy;
	BOOL shutdown;
